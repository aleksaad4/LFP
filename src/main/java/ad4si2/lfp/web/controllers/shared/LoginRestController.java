...
public class LoginRestController {
    ...
    public AjaxResponse login(@Nonnull final HttpServletRequest request, @Nonnull final HttpServletResponse response,
        ...
        if (account == null) {
            ...
            return webUtils.errorResponse(EntityValidatorResult.validatorResult("common.login_failed", "Incorrect login or password").getErrors());
        }
    ...
    private AjaxResponse validateLoginData(@Nonnull final LoginRequestData loginRequestData) {
        ...
        if (result.hasErrors()) {
            return webUtils.errorResponse(result.getErrors());
        }
        return null;
    }
